 ...
 * يولّد معرّفًا جديدًا على الجهاز نفسه، فيحتاج المستخدم إبطالًا من المسؤول.
...
/**
 * اسم وصفي للجهاز يميّزه في قائمة المسؤول.
 *
 * يُشتقّ من نظام التشغيل وحده — لا يحمل اسم المستخدم ولا أي معرّف. المسؤول
